...
* **ci:** attach release artifacts before the release is published ([e5ef699](https://github.com/daFish/gogo-meta/commit/e5ef699a3d88059e65f5bcfc1246bc87b5a301d0))

## [3.1.0](https://github.com/daFish/gogo-meta/compare/v3.0.1...v3.1.0) (2026-09-07)
...
* **config:** auto-merge .gogo.local overlay in global mode ([1673c4c](https://github.com/daFish/gogo-meta/commit/1673c4ced423f3071222666e826f0e8c37bfba36))


### Bug Fixes

* **cli:** announce the merged overlays once when --group is used ([3c698cb](https://github.com/daFish/gogo-meta/commit/3c698cb0fa3e40f1d48a4bf49b4710fe9ae5f4d1))
* **config:** apply the config ownership guard to the auto-loaded .gogo.local ([ade34cd](https://github.com/daFish/gogo-meta/commit/ade34cdb28b6dbe050d670cfb1a247d5fc8fe588))
